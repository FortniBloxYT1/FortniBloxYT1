...
def downloadsocks(choice):
    ...
    if choice == "5":
        f = open(out_file, 'wb')
        try:
            r = requests.get("https://raw.githubusercontent.com/Yonee3/socks5c/main/socks5mh.txt", timeout=5)
            f.write(r.content)
        except:
            pass
        try:
    ...
    if choice == "1":
        f = open(out_file, 'wb')
        try:
            r = requests.get("https://raw.githubusercontent.com/Yonee3/httpmh/main/httpmh.txt", timeout=5)
            f.write(r.content)
        except:
            pass
        try:
...
def usge():
    usgeaseets()
    print('* Coded By The-DeepNet For Better Stresser')
